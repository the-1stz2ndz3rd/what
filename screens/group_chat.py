...
from utils.chat_manager import get_group_messages, add_group_message  # ✅ Corrected imports
...
class GroupChatScreen(tk.Frame):
    def __init__(self, parent, controller, group_name, current_user):
        ...
        tk.Label(
            self,
            text="{} Group Chat".format(self.group_name),
            font=("Arial", 16, "bold"),
            bg=bg_color
        ).pack(pady=10)
    ...
    def load_messages(self):
        ...
        messages = get_group_messages(self.group_name)  # ✅ updated function
        theme = get_theme_for_group(self.group_name)
    ...
    def send_message(self, event=None):
        ...
        add_group_message(self.group_name, self.current_user, text)  # ✅ updated function
